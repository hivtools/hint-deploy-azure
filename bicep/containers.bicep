...
@description('The name of the active jobs function app')
...
resource faSubnet 'Microsoft.Network/virtualNetworks/subnets@2023-11-01' existing = {
  name: '${prefix}-functionapp-subnet'
  parent: vnet
}

module activeJobsFunctionAppModule 'app/active_jobs_fa.bicep' = {
  name: 'activeJobs'
  params: {
    location: location
    prefix: prefix
    redisConnectionString: redisInfo.connectionString
    faBlobStorageAccountName: faBlobStorageAccountName
    faStorageContainerName: faStorageContainerName
    activeJobsFunctionAppName: activeJobsFunctionAppName
    hintResourceGroup: hintResourceGroup
    logAnalyticsWorkspaceName: logAnalyticsWorkspaceName
    logsResourceGroup: logsResourceGroup
    subnetId: faSubnet.id
  }
}
...
module workerJobModule 'app/worker_job.bicep' = {
  ...
  params: {
    ...
    activeJobsFAUrl: activeJobsFunctionAppModule.outputs.functionAppUrl
  }
}
