...
@description('The name of the uploads file share')
param uploadsShareName string

@description('The name of the results file share')
param resultsShareName string

@description('The name of the config file share')
param configShareName string

@description('The name of the uploads file share mount in container app environment')
param uploadsMountName string

@description('The name of the results file share mount in container app environment')
param resultsMountName string

@description('The name of the config file share mount in container app environment')
param configMountName string
...
@description('Create an Azure File Share for uploads')
resource fileShareUploads 'Microsoft.Storage/storageAccounts/fileServices/shares@2023-05-01' = {
  parent: fileService
  name: uploadsShareName
}

@description('Create an Azure File Share for results')
resource fileShareResults 'Microsoft.Storage/storageAccounts/fileServices/shares@2023-05-01' = {
  parent: fileService
  name: resultsShareName
}

@description('Create an Azure File Share for config')
resource fileShareConfig 'Microsoft.Storage/storageAccounts/fileServices/shares@2023-05-01' = {
  parent: fileService
  name: configShareName
}

resource storageUploadMount 'Microsoft.App/managedEnvironments/storages@2024-03-01' = {
  parent: containerAppsEnvironment
  name: uploadsMountName
  properties: {
    azureFile: {
      accountName: storageAccount.name
      shareName: fileShareUploads.name
...
resource storageResultsMount 'Microsoft.App/managedEnvironments/storages@2024-03-01' = {
  parent: containerAppsEnvironment
  name: resultsMountName
  properties: {
    azureFile: {
      accountName: storageAccount.name
      shareName: fileShareResults.name
      accountKey: storageAccount.listKeys().keys[0].value
      accessMode: 'ReadWrite'
    }
  }
...
resource storageConfigMount 'Microsoft.App/managedEnvironments/storages@2024-03-01' = {
  parent: containerAppsEnvironment
...
param uploadsVolume string

@description('Name of results volume')
param resultsVolume string
      ...
      volumes: [
        {
          ...
          storageName: uploadsMountName
        }
        {
          name: resultsVolume
          storageType: 'AzureFile'
          storageName: resultsMountName
        }
      ]
    }
